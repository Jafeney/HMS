<?php
    ...
    /**
     * @desc 编辑客户的内容
     * @example http://www.hms.com/HMS/API/action/admin/users_edit.act.php?id=1&name=盛燕妮&card=330686199401307024&sex=女&phone=18367854605&address=温州医科大学茶山校区&rank=1
     */
    ...
    if($res){
        $res=$_mysqli->db_query("SELECT * from customer where c_id='$c_id'");
